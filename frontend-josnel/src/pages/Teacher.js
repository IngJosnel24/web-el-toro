          ...
          <Card.Body>
            ...
            <Form className="mt-3" onSubmit={handleSubmit}>
              <Row className="g-3">
                ...
                <Col sm="6" md="6" lg="4">
                  <FloatingLabel controlId="nombres" label="Nombre Producto">
                    <Form.Control
                      type="text"
                ...
                <Col sm="6" md="6" lg="4">
                  <FloatingLabel controlId="apellidos" label="Cantidad">
                    <Form.Control
                      type="text"
                ...
                <Col sm="12" md="6" lg="4">
                  <FloatingLabel controlId="fechaNacimiendo" label="Fecha de vencimiento">
                    <Form.Control 
                      type="date" 
                      placeholder="Seleccione la fecha de venciemiento"
                ...
                <Col sm="12" md="6" lg="4">
                  <FloatingLabel controlId="genero" label="Tipo de Producto">
                    <Form.Select 
                      aria-label="Genero"
                      value={Genero}
